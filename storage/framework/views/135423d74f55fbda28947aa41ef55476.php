    ...
    <div class="certificate">
        ...
        <div class="content">
            ...
            <div class="recipient-section">
                <span class="recipient"><?php echo e($userName); ?></span>
                <span class="recipient-dono">殿</span>
            </div>
            
            <div class="exam-info">
                <span class="exam-name">プログラマー適性検査</span>
                <span class="rank-name"><?php echo e($rankName); ?></span>
            </div>
            
            <div class="abilities">
                <div class="ability-row">
                    <span class="ability-label">規則発見力:</span>
                    <span class="stars"><?php echo e(str_repeat('★', $part1Stars)); ?></span>
                </div>
                
                <div class="ability-row">
                    <span class="ability-label">空間把握力:</span>
                    <span class="stars"><?php echo e(str_repeat('★', $part2Stars)); ?></span>
                </div>
                
                <div class="ability-row">
                    <span class="ability-label">問題解決力:</span>
                    <span class="stars"><?php echo e(str_repeat('★', $part3Stars)); ?></span>
                </div>
            </div>
            ...
            <div class="date"><?php echo e($formattedDate); ?></div>
            
            <div class="footer">
                <div class="logo-container">
                    <?php if($logoData): ?>
                        <img src="data:image/png;base64,<?php echo e($logoData); ?>" alt="YICロゴ" class="logo-image">
                    <?php else: ?>
                ...
                <div class="signature-area">
                    ...
                    <?php if(!empty($stampData)): ?>
                        <img src="data:image/gif;base64,<?php echo e($stampData); ?>" alt="印鑑" class="stamp-image">
                    <?php else: ?>
...
</html><?php /**PATH /var/www/html/resources/views/certificate.blade.php ENDPATH**/ ?>